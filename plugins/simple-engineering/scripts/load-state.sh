...
if [ ! -d "$STATE_DIR" ]; then
    ...
    echo "새 프로젝트입니다. /simple:research로 시작하세요."
    exit 0
fi
...
if [ ! -f "$STATE_FILE" ]; then
    ...
    echo "/simple:research로 새 작업을 시작하세요."
    exit 0
fi
...
echo "- Research 계속: /simple:research [task]"
echo "- Planning 계속: /simple:plan [research-file]"
echo "- Implementation 계속: /simple:implement [spec-file]"
